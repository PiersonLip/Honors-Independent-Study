...
\section{\centering Data Acquisition}
    ...
    \section{\centering Results}
        ...
        \subsection{\centering Roche Lobe Overflow (V404 Cyngi)}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale = .6]{figs/GeneratedFigs/ Contact binaries Star Two Mass log10 F star radius T.png}
        ...
        \subsubsection{W UMa Cygni Results}
            \begin{figure}[H]
                \centering
                \includegraphics[scale = .6]{figs/GeneratedFigs/ W Ursae Majories HR Context Star Two Mass log10 F star radius 5.png}
