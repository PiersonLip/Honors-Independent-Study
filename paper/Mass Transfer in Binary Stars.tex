...
% distrobution of masses for contact binaries
...
\section{\centering Data Acquisition}
    ...
    \section{\centering Results}
        ...
        \begin{figure}[H]
            ...
            \caption{Eccentricity distribution of contact Binaries}
            \label{contactBinaryMassDistro}
        \end{figure}
        In figure \ref{contactBinaryMassDistro} we can see that contact binaries mass distribution feature a prominent spike at around one solar mass, with a distribution centered around 10, and then a scattered amount afterward. 
        ...
        \end{figure}
        This is one of the more interesting results, as we can see that contact binaries form a very specific population on the HR diagram, falling on specific linear with a linear relationship. This is because 
        ...
        \subsubsection{W UMa Cygni Results}
            \begin{figure}[H]
                ...
                \label{WUMaResults}
            \end{figure}
            In figure \ref{WUMaResults} we see that W UMa also follows this linear relationship, however, it has a much lower temperature and luminosity then most of the population.
        ...
        \subsection{\centering Detached Binaries}
            \begin{figure}[H] 
                ...
                \caption{HR Diagram with of HMXBS}
                \label{DetachedBinary}
            \end{figure}
...
\section{\centering Conclusion}
    In conclusion mass transfer heavily affects the evolution of binary stars, leading them to evolve in a  

    \subsection{W UMa Cyngi} \label{WUMaConc}

    \subsection{Vela X-1 Cyngi} \label{VelaX1Conc}
