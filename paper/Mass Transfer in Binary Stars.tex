...
\section{\centering Introduction} % amaybe include a section on x-ray emission???
    ...
    \vspace*{\fill}
        ...
        \subsection{\centering Semi-detached Binaries}\label{RLO} % maybe include equations??
...
\section{\centering Data Acquisition}
    ...
    \subsection{\centering V404 Cygni (Roche Lobe Overflow)} \label{V404Introduction}
        \subsubsection{Known properties}
    ...
    \subsection{\centering Semi-Detached Binaries (RLO)}
        \begin{figure}[H]
            \centering
